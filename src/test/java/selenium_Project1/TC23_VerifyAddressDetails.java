...
public class TC23_VerifyAddressDetails {
	WebDriver driver;
	@BeforeSuite
	...
	public void signUporLogin() throws InterruptedException{
		...
		driver.findElement(By.xpath("//div[@class='signup-form']//form//input[3]")).sendKeys("minakshi54678@gmail.com");
	...
	{
		String deliveryAdd=driver.findElement(By.xpath("//h3[contains(text(),'Your delivery address')]")).getText();
		Assert.assertEquals(deliveryAdd, "YOUR DELIVERY ADDRESS");
		System.out.println(deliveryAdd);
		String billingAdd=driver.findElement(By.xpath("//h3[contains(text(),'Your billing address')]")).getText();
		Assert.assertEquals(billingAdd, "YOUR BILLING ADDRESS");
