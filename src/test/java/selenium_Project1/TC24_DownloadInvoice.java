...
public class TC24_DownloadInvoice {
	...
	{
		driver.findElement(By.xpath("//div[@class='modal-body']/p[2]/a")).click();
		driver.findElement(By.xpath("//div[@class='col-sm-8']/child::div/child::ul/child::li[4]")).click();
		driver.findElement(By.xpath("//input[@name='name']")).sendKeys("Minu");
		driver.findElement(By.xpath("//input[@data-qa='signup-email']")).sendKeys("Minakshi342@gmail.com");
